...
export const Sections = () => {
  ...
  return (
    ...
    >
      <motion.div className="listContainer" variants={secVariants}>
        <motion.div className="box">
          ...
          <motion.h2 variants={secVariants}>Creación o maduración de PMO</motion.h2>
        ...
        <motion.div className="box">
          ...
          <motion.h2 variants={secVariants}>Optimización de Portafolios de Proyectos</motion.h2>
          <motion.p variants={secVariants}>
        ...
        <motion.div className="box">
          ...
          <motion.h2 variants={secVariants}>Capacitación y Coaching en Gestión de Proyectos</motion.h2>
          <motion.p variants={secVariants}>
